...
urlpatterns = [
    ...
    # path('title/<int:title_id>/copies/', views.copy_list_by_title, name='copy_list_by_title'),
    path('issue/<int:id>/',         views.copy_list,       name='copy_list'),
    path('title/<int:edition_id>/copies/', views.copy_list_by_edition, name='copy_list_by_edition'),
